...
static uint16_t LSM6DS3_ExtractOdrHz(uint8_t reg_value) {
    ...
    switch (odr_code) {
        ...
        case 0x4:
            return 104;
        case 0x8:
            return 1660;  // 1.66 kHz
        case 0x9:
            return 3330;  // 3.33 kHz
        case 0xA:
            return 6660;  // 6.66 kHz
        default:
            return 0;  // Off/invalid
    }
}
...
static uint8_t LSM6DS3_ExtractAccelRangeG(uint8_t ctrl1_xl) {
    ...
    switch (fs_code) {
        ...
        case 0x3:
            return 8;
        default:
            return 2;  // Default to 2G if invalid
    }
}
...
static uint16_t LSM6DS3_ExtractGyroRangeDps(uint8_t ctrl2_g) {
    ...
    switch (fs_code) {
        ...
        case 0x3:
            return 2000;
        default:
            return 245;  // Default to 245 DPS if invalid
    }
}
...
static void Lsm6ds3_ResetTimeout(void) { timeoutCnt = 0; }
