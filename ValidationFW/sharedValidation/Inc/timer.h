...
#define SEND_RESPONSE_TMR                            (2u)
#define SEND_RESPONSE_TMR_PERIOD_MS                  (20u)

#define SEND_TEST_IND_TMR                            (9u)
#define SEND_TEST_IND_TMR_PERIOD_MS                  (2000u)
...
#define VUSA_CHECK_TMR_DELAY_PERIOD_MS               (10u)
#define VUSA_POLL_TMR_DELAY_PERIOD_MS                (200u)

#define SELF_DISTRUCTION_TMR                         (8u)
#define SELF_DISTRUCTION_TMR_LOST_PERIOD_MINUTES     (180u)
...
#define PUMP_MEASURE_TMR                             (14u)
#define PUMP_MEASURE_TMR_PERIOD_MS  		     	 (100u)
#define VCAP_MONITOR_MEASURE_TMR_PERIOD_MS      	 (2000u) //set 30 sec
