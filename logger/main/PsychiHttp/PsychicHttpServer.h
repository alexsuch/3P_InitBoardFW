...
class PsychicHttpServer {
   protected:
    ...
    // Private helper to initialize configuration from custom config or defaults
    void initFromConfig(const httpd_config_t* custom_config);

   public:
    PsychicHttpServer();
    PsychicHttpServer(const httpd_config_t* custom_config);
    ...
    esp_err_t lastEndpointError() const;
