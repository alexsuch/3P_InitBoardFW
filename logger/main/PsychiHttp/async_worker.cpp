...
/* ESP-IDF 5.5 compatibility: HTTPD_* macros moved to CONFIG_HTTPD_* */
...
void start_async_req_workers(void) {
    ...
    worker_ready_count = xSemaphoreCreateCounting(ASYNC_WORKER_COUNT,  // Max Count
                                                  0);                  // Initial Count
...
// Use ESP-IDF's native implementation - remove custom implementation
